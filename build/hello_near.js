...
let HelloNear = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec(_class = (_class2 = class HelloNear {
  ...
  set_message({
    ...
    this.greetings[predecessorAccountId()] = message;
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "get_message", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_message"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_message", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "set_message"), _class2.prototype)), _class2)) || _class);
function set_message() {
  ...
  const _result = _contract.set_message(_args);
...
function get_message() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_message(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}

export { get_message, set_message };
